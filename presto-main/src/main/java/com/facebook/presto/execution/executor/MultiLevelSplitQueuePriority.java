 ...
 */
@Immutable
public final class MultiLevelSplitQueuePriority
        implements Priority
{
    private final int level;
    private final long levelPriority;

    public MultiLevelSplitQueuePriority(int level, long levelPriority)
    {
        this.level = level;
    ...
    {
        return Long.compare(this.getLevelPriority(), ((MultiLevelSplitQueuePriority) o).getLevelPriority());
    }
